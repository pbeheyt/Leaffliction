...
def analyze_dataset(directory):
    """
    Analyzes the dataset by counting images per subdirectory
    and generates distribution charts (pie and bar charts).
    """
...
def main():
    parser = argparse.ArgumentParser(description="Analyses the distribution of images in a dataset.")
